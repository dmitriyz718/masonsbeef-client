...
class RegisterModal extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <Button onClick={this.toggle} href="#" className="nav-btn" outline color="info" style={{ margin: '1rem' }}>Register</Button>
                    ...
                    <ModalBody>
                        ...
                        <Form onSubmit={this.onSubmit}>
                            <FormGroup>
                                ...
                                <Input type="text" name="username" id="username" placeholder="User Name" onChange={this.onChange} className="mb-3" />
